...
wget -O box.sh https://raw.fastgit.org/BlueSkyXN/SKY-BOX/main/box.sh && chmod +x box.sh && clear && ./box.sh

<pre>wget -O box.sh https://raw.fastgit.org/BlueSkyXN/SKY-BOX/main/box.sh && chmod +x box.sh && clear && ./box.sh</pre>

### ARM beta使用方法
<details><summary>ARM beta使用方法</summary>
wget -O box.sh https://raw.fastgit.org/BlueSkyXN/SKY-BOX/main/armbox.sh && chmod +x box.sh && clear && ./box.sh

<pre>wget -O box.sh https://raw.fastgit.org/BlueSkyXN/SKY-BOX/main/armbox.sh && chmod +x box.sh && clear && ./box.sh</pre>
</details>
